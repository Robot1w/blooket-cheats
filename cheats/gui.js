...
(() => {
        ...
        const guiWrapper = createElement("div", {
            ...
            (gui = createElement("div", {
                ...
                createElement("div", {
                    ...
                    innerHTML: "GitHub - Sh1N02",
                    onclick: () => window.open("https://github.com/Sh1N022/Blooket-Cheats", "_blank").focus()
                }),
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Sh1N02/Blooket-Cheats/main/autoupdate/timestamps/gui.png?" + Date.now();
